...
- Pengerjaan : Individu
- Durasi : 2 minggu (12 Desember 2025; 23.59 WIB)
...
1. Array (tidak harus multidimensi, string/array of char tidak terhitung)
2. Pointer
3. Struct 
4. Rekursi
5. Linked List
6. File Handling (Opsional)
7. Stack, QueQue dan Tree (Opsional)
...
- `Responsi2_L0124147_AndradhiBondanPamungkas_BambooMaker.c`
- `Responsi2_L0124147_AndradhiBondanPamungkas_BambooMaker.pdf`
